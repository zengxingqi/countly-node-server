...
if (!window['google']['loader']) {
    ...
    google.loader.GoogleApisBase = 'https://ajax.lug.ustc.edu.cn/ajax';
    ...
    (function () {
        var g = this,
            l = function (a, b, c) {
                ...
                for (var d; a.length && (d = a.shift());) a.length || void 0 === b ? c = c[d] && c[d] !== Object.prototype[
                        d] ? c[d] : c[d] = {} : c[d] = b
            }, m = function (a, b, c) {
                a[b] = c
            };
        var w = function (a, b) {
            if (b) a = a.replace(n, "&amp;").replace(p, "&lt;").replace(q, "&gt;").replace(r, "&quot;").replace(t,
                    "&#39;").replace(u, "&#0;");
            else {
                if (!v.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(n, "&amp;")); - 1 != a.indexOf("<") &&
                    (a = a.replace(p, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(q, "&gt;")); - 1 != a.indexOf(
                    '"') && (a = a.replace(r, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(t, "&#39;")); - 1 !=
                    a.indexOf("\x00") && (a = a.replace(u, "&#0;"))
            }
            return a
        }, n = /&/g,
            p = /</g,
        ...
        google.load = function (a, b, c) {
            ...
            var e = a;
            c = c || {};
            if (a instanceof Array || a && "object" == typeof a && "function" == typeof a.join && "function" == typeof a
                .reverse) for (var f = 0; f < a.length; f++) d(a[f]);
            else d(a); if (a = G[":" + e]) {
                ...
                if ((f = c && null != c.callback) && !a.D(b)) throw D("Module: '" + e +
        ...
        google.ca = function (a, b) {
            b ? (0 == I.length && (J(window, "load", K), !y("msie") && !y("safari") && !y("konqueror") && y("mozilla") ||
                window.opera ? window.addEventListener("DOMContentLoaded", K, !1) : y("msie") ? document.write(
                "<script defer onreadystatechange='google.loader.domReady()' src=//:>\x3c/script>") : (y("safari") || y(
                "konqueror")) && window.setTimeout(L, 10)), I.push(a)) : J(window, "load", a)
        };
        ...
        google.loader.f = function (a, b, c) {
            a: {
                var d = g.document;
                if ((d = d.querySelector && d.querySelector("script[nonce]")) && (d = d.nonce || d.getAttribute("nonce")) &&
                    x.test(d)) break a;
                d = void 0
            }
            if (c) {
                ...
                } else "css" == a && (e = document.createElement("link"), e.type = "text/css", e.href = b, e.rel =
                        "stylesheet");
                (a = document.getElementsByTagName("head")[0]) || (a = document.body.parentNode.appendChild(document.createElement(
                    "head")));
                a.appendChild(e)
            } else "script" == a ? (e = '<script src="' + w(b) + '" type="text/javascript"', d && (e += ' nonce="' + w(
                    d) + '"'), document.write(e + ">\x3c/script>")) : "css" == a && (e = '<link href="' + w(b) +
                    '" type="text/css" rel="stylesheet"', d && (e += ' nonce="' + w(d) + '"'), document.write(e +
                    "></link>"))
        };
        ...
        google.loader.ba = function (a) {
            for (var b in a) "string" == typeof b && b && ":" == b.charAt(0) && !G[b] && (G[b] = new O(b.substring(1),
                    a[b]))
        };
        ...
        google.loader.aa = function (a) {
            if ((a = a.specs) && a.length) for (var b = 0; b < a.length; ++b) {
                    var c = a[b];
                    "string" == typeof c ? G[":" + c] = new P(c) : (c = new Q(c.name, c.baseSpec, c.customSpecs), G[":" +
                        c.name] = c)
            }
        };
        ...
        google.loader.a.K = "//www.google.cn/cse/static/style/look/bubblegum.css";
        m(google.loader.a, "BUBBLEGUM", google.loader.a.K);
        google.loader.a.M = "//www.google.cn/cse/static/style/look/greensky.css";
        m(google.loader.a, "GREENSKY", google.loader.a.M);
        google.loader.a.L = "//www.google.cn/cse/static/style/look/espresso.css";
        m(google.loader.a, "ESPRESSO", google.loader.a.L);
        google.loader.a.O = "//www.google.cn/cse/static/style/look/shiny.css";
        m(google.loader.a, "SHINY", google.loader.a.O);
        google.loader.a.N = "//www.google.cn/cse/static/style/look/minimalist.css";
        m(google.loader.a, "MINIMALIST", google.loader.a.N);
        google.loader.a.P = "//www.google.cn/cse/static/style/look/v2/default.css";
        ...
        P.prototype.i = function (a, b) {
            var c = "";
            void 0 != b && (void 0 != b.language && (c += "&hl=" + encodeURIComponent(b.language)), void 0 != b.nocss &&
                (c += "&output=" + encodeURIComponent("nocss=" + b.nocss)), void 0 != b.nooldnames && (c +=
                "&nooldnames=" + encodeURIComponent(b.nooldnames)), void 0 != b.packages && (c += "&packages=" +
                encodeURIComponent(b.packages)), null != b.callback && (c += "&async=2"), void 0 != b.style && (c +=
                "&style=" + encodeURIComponent(b.style)), void 0 != b.noexp && (c += "&noexp=true"), void 0 != b.other_params &&
                (c += "&" + b.other_params));
            if (!this.s) {
        ...
        P.prototype.H = function (a) {
            ...
            if (b) if ("string" == typeof b) c = [a.packages];
                else if (b.length) for (c = [], a = 0; a < b.length; a++) "string" == typeof b[a] && c.push(b[a].replace(
                        /^\s*|\s*$/, "").toLowerCase());
            c || (c = ["default"]);
            b = [];
        ...
        P.prototype.load = function (a, b) {
            ...
            if (c.length) {
                ...
                if (b || null == H[":" + this.b] || null == H[":" + this.b].versions[":" + a] || google.loader.AdditionalParams || !
                    this.s) b && b.autoloaded || google.loader.f("script", this.i(a,
                        b), d);
                else {
                    a = H[":" + this.b];
                    google[this.b] = google[this.b] || {};
                    for (var B in a.properties) B && ":" == B.charAt(0) && (google[this.b][B.substring(1)] = a.properties[
                            B]);
        ...
        var T = function (a, b) {
            return a.string ? encodeURIComponent(a.string) + "=" + encodeURIComponent(b) : a.regex ? b.replace(/(^.*$)/,
                a.regex) : ""
        };
        ...
        Q.prototype.X = function (a, b, c) {
            ...
            if (null != c) for (var e in c) a.params[e] ? d += "&" + T(a.params[e], c[e]) : "other_params" == e ? d +=
                        "&" + c[e] : "base_domain" == e && (b = "http://" + c[e] + a.uri.substring(a.uri.indexOf("/", 7)));
        ...
        O.prototype.i = function (a, b) {
            ...
            return google.loader.GoogleApisBase + "/libs/" + this.b + "/" + a + "/" + this.h.versions[":" + a][b && b.uncompressed ?
            ...
            X = function () {
                ...
                if (!(google.loader.Secure || google.loader.Options && !1 !== google.loader.Options.csi)) {
                    for (var c = 0; c < a.length; c++) a[c] = encodeURIComponent(a[c].toLowerCase().replace(
                            /[^a-z0-9_.]+/g, "_"));
                    for (c = 0; c < b.length; c++) b[c] = encodeURIComponent(b[c].toLowerCase().replace(/[^a-z0-9_.]+/g,
                            "_"));
                    window.setTimeout(C(Y, null, "//gg.google.cn/csi?s=uds&v=2&action=" + a.join(",") + "&it=" + b.join(
                        ",")), 1E4)
                }
            }, S = function (a,
                b, c) {
    ...
    google.loader.rm({
        "specs": ["visualization", "payments", {
                "name": "annotations",
                "baseSpec": {
                    "uri": "http://www.google.cn/reviews/scripts/annotations_bootstrap.js",
                    "ssl": null,
                    "key": {
                        "string": "key"
                    },
            ...
            }, "language", "gdata", "wave", "spreadsheets", "search", "orkut", "feeds", "annotations_v2", "picker",
                "identitytoolkit", {
                "name": "maps",
                "baseSpec": {
                    "uri": "http://maps.google.cn/maps?file\u003dgoogleapi",
                    "ssl": "https://maps-api-ssl.google.cn/maps?file\u003dgoogleapi",
                    "key": {
                        "string": "key"
                    },
                    "version": {
                ...
                "customSpecs": [{
                        "uri": "http://maps.google.cn/maps/api/js",
                        "ssl": "http://maps.google.cn/maps/api/js",
                        "version": {
                            "string": "v"
                        },
                        "deferred": true,
                ...
                "name": "friendconnect",
                "baseSpec": {
                    "uri": "http://www.google.cn/friendconnect/script/friendconnect.js",
                    "ssl": "https://www.google.cn/friendconnect/script/friendconnect.js",
                    "key": {
                        "string": "key"
                    },
                    "version": {
                ...
                "name": "sharing",
                "baseSpec": {
                    "uri": "http://www.google.cn/s2/sharing/js",
                    "ssl": null,
                    "key": {
                        "string": "key"
                    },
                ...
                "name": "books",
                "baseSpec": {
                    "uri": "http://books.google.cn/books/api.js",
                    "ssl": "https://encrypted.google.cn/books/api.js",
                    "key": {
                        "string": "key"
                    },
                    "version": {
    ...
    google.loader.rfm({
        ":search": {
            ...
            "path": "/api/search/1.0/c891f6315aacc94dc79953d1f142739e/",
            "js": "default+zh_CN.I.js",
            "css": "default+zh_CN.css",
            "properties": {
                ":Version": "1.0",
                ":NoOldNames": false,
                ":JSHash": "c891f6315aacc94dc79953d1f142739e"
            }
        },
        ":language": {
            "versions": {
